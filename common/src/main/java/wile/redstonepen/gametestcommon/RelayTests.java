...
public final class RelayTests
{
  ...
  {
    BlockState s = relayState(Direction.DOWN, 0);
  ...
  {
    BlockState s = relayState(Direction.DOWN, 1);
  ...
  {
    BlockState s = relayState(Direction.DOWN, 2);
  ...
  {
    BlockState s = relayState(Direction.DOWN, 3);
  ...
  private static BlockState relayState(Direction facing, int rotation)
  {

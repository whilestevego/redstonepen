...
class DemoBuilderTest {
    @Test fun cellOriginIndexZeroReturnsGridOrigin() {
        val origin = BlockPos(10, 64, 20)
        assertEquals(origin, DemoBuilder.cellOrigin(origin, 0, 4, 3))
    }

    @Test fun cellOriginAdvancesAcrossColumnsBeforeAdvancingRow() {
    ...
    @Test fun regionVolumeOrderIndependent() {

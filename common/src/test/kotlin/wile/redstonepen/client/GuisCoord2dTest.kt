...
class GuisCoord2dTest {
    @Test fun constructorStoresXAndY() {
        val c = Coord2d(3, 7)
        assertEquals(3, c.x)
        assertEquals(7, c.y)
    }

    @Test fun ofFactoryCreatesEquivalentCoord() {
        val a = Coord2d(5, 9)

...
class DirectedComponentBlockTest {
    companion object {
        ...
        @JvmStatic fun placementRotationCases(): Stream<Arguments> = Stream.of(
    ...
    fun placementRotation(face: Direction, dir: Direction, expectedRotation: Int) {
        assertEquals(expectedRotation,
            CircuitComponents.DirectedComponentBlock.placementRotation(face, dir)) { "face=$face dir=$dir" }
    }
}

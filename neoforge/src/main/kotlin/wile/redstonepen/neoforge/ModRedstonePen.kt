...
class ModRedstonePen(bus: IEventBus) {
    init {
        ...
        NeoForge.EVENT_BUS.addListener { e: RegisterCommandsEvent ->
            DemoCommand.register(e.dispatcher)
        }
    ...
    companion object {
        ...
        // java.util.function.Supplier explicit cast resolves ambiguity with
        // DeferredRegister.register(String, Function<ResourceLocation, I>) overload
        @JvmField
                    ...
                    CreativeModeTab.builder()
                        ...
                        .displayItems { _, output ->
                            Registries.getRegisteredItems().forEach {
                                if (
                                    it !is BlockItem ||
                                        it.block != ModContent.References.TRACK_BLOCK
                                ) {
                                    output.accept(it)
                                }
                            }
    ...
    private class LiveCycleEvents {
        companion object {
            ...
            @JvmStatic
            fun onRegisterNetwork(event: RegisterPayloadHandlersEvent) {
        ...
        companion object {
            ...
            fun onClientSetup(_event: FMLClientSetupEvent) {
                ...
                BlockEntityRenderers.register(
                    Registries.getBlockEntityTypeOfBlock("track")
                        as BlockEntityType<TrackBlockEntity>
                ) { ctx ->
            ...
            fun onRegisterModels(event: ModelEvent.RegisterAdditional) {
                ModRenderers.TrackTer.registerModels()
                    .map {
                        net.minecraft.client.resources.model.ModelResourceLocation(it, "standalone")
                    }
